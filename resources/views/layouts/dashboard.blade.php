...
<head>
  ...
  <link
    rel="stylesheet"
    href="{{ asset('mazer/dist/assets/compiled/css/app.css') }}"
  />
  <link
    rel="stylesheet"
    href="{{ asset('mazer/dist/assets/compiled/css/app-dark.css') }}"
  />
  <link
    rel="stylesheet"
    href="{{ asset('mazer/dist/assets/compiled/css/iconly.css') }}"
  />
  <link rel="stylesheet" href="{{ asset('mazer/dist/assets/extensions/simple-datatables/style.css') }}">
  <link rel="stylesheet" href="{{ asset('mazer/dist/assets/extentions/table-datatables.css') }}">
...
<body>
      ...
      <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative">
          <div class="d-flex justify-content-between align-items-center">
            <div class="logo">
              <a href="index.html"
                ><img
                  src="{{ asset('mazer/dist/assets/compiled/svg/logo.svg') }}"
                  alt="Logo"
                  srcset=""
              /></a>
            </div>
        ...
        <div class="sidebar-menu">
          <ul class="menu">
            ...
            @if (in_array(session('role'), ['Developer', 'Manager', 'Sales', 'Data Entry']))
              <li class="sidebar-item {{ request()->is('dashboard') ? 'active' : '' }}">
                <a href="{{ url('/dashboard') }}" class="sidebar-link">
                  <i class="bi bi-grid-fill"></i>
                  <span>Dashboard</span>
      ...
      <footer>
        <div class="footer clearfix mb-0 text-muted">
          <div class="float-start">
            <p>2025 &copy; Syarif HIdayatullah</p>
          </div>
          <div class="float-end">
            <p>
  ...
  <script
    src="{{ asset('mazer/dist/assets/extensions/perfect-scrollbar/perfect-scrollbar.min.js') }}"
  ></script>
  <script src="{{ asset('mazer/dist/assets/compiled/js/app.js') }}"></script>

  {{-- Need: Apexcharts --}}
  <script
    src="{{ asset('mazer/dist/assets/extensions/apexcharts/apexcharts.min.js') }}"
  ></script>
  <script
    src="{{ asset('mazer/dist/assets/static/js/pages/dashboard.js') }}"
  ></script>

  {{-- Need: ChartJs --}}
  <script
    src="{{ asset('mazer/dist/assets/extensions/chart.js/chart.umd.js') }}"
  ></script>

  {{-- Dibutuhkan untuk handle datatables --}}
  <script
    src="{{ asset('mazer/dist/assets/extensions/simple-datatables/umd/simple-datatables.js') }}"
  ></script>
  <script
    src="{{ asset('mazer/dist/assets/static/js/pages/simple-datatables.js') }}"
  ></script>
