      ...
      <div class="card-body">
        ...
        <form action="{{ route('payrolls.store') }}" method="post">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" name="bonuses" required>
            @error('bonuses')
              <div class="invalid-feedback">{{ $message }}</div>
            @enderror
          </div>
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" name="deductions" required>
            @error('deductions')
              <div class="invalid-feedback">{{ $message }}</div>
            @enderror
          </div>
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" name="net_salary" required>
            @error('net_salary')
              <div class="invalid-feedback">{{ $message }}</div>
            @enderror
          </div>
