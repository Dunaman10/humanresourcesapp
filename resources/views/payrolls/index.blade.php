          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                {{-- Tomboll.. --}}
                @if (session('role') == 'HR')
                  <a href="{{ route('payrolls.edit', $payroll->id) }}" target="_blank" class="btn btn-warning btn-sm">Edit</a>
                ...
                @endif
                <a href="{{ route('payrolls.show', $payroll->id) }}" target="_blank" class="btn btn-info btn-sm">Salary Slip</a>
