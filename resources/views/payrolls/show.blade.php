      ...
      <div class="card-body">
        ...
        <div id="print-area">
          <div class="row">
            <div class="col-md-6">
              <div class="mb-3">
                <label for="employee" class="form-label"><strong>Employee</strong></label>
        ...
        <button type="button" id="btn-print" class="btn btn-primary mt-3"><span class="bi bi-printer"></span> Print</button>
